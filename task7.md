...
Внешние ключи ускориться не помогли. 
...
```
Используя хэш-соединение, PostgreSQL создает хэш-таблицу в памяти из меньшей таблицы и проверяет эту хэш-таблицу для каждой строки в большей таблице, не используя созданные индексы.
